    ...
    <div className="m-4 md:w-[40%] z-5">
        ...
        style={{ background: `url(${imgUrl})`, backgroundSize: "cover"}}>
          ...
          transition-all duration-500 items-center justify-center">
            ...
            relative rounded-full border-[#ADB7BE] hover:border-white group/link mr-4">
            ...
            relative rounded-full border-[#ADB7BE] hover:border-white group/link ">
